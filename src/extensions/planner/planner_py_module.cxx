...
#include <lapkt/planner/at_bfs_f/at_bfsf_planner.hxx>
#include <lapkt/planner/bfs_f/bfsf_planner.hxx>
#include <lapkt/planner/brfs/brfs_planner.hxx>
#include <lapkt/planner/bfws/bfws.hxx>
#include <lapkt/planner/delete-free-iw/dfiw_planner.hxx>
#include <lapkt/planner/delete-free-siw/dfsiw_planner.hxx>
#include <lapkt/planner/dfs_plus/dfs_plus_planner.hxx>
#include <lapkt/planner/iw/iw_planner.hxx>
#include <lapkt/planner/iw_plus/rp_iw_planner.hxx>
#include <lapkt/planner/siw/siw_planner.hxx>
#include <lapkt/planner/siw_plus/siw_plus_planner.hxx>
#include <lapkt/planner/siw_plus-then-bfs_f/siw_plus_bfs_f.hxx>

#include <lapkt/planner/apx_bfws/approximate_bfws.hxx>
// #include <lapkt/planner/apx_dfs_plus/approximate_dfs_plus.hxx>
// #include <lapkt/planner/apx_iw/approximate_iw.hxx>
// #include <lapkt/planner/apx_iw_plus/approximate_rp_iw.hxx>
// #include <lapkt/planner/apx_siw/approximate_siw.hxx>
...
PYBIND11_MODULE(planner, m)
{
  ...
  py::class_<AT_LAPKT_Planner, Planner>(m, "AT_LAPKT_Planner")
    .def(py::init<>())
  ...
  py::class_<AT_BFS_f_Planner, Planner>(m, "AT_BFS_f_Planner")
    .def(py::init<>())
  ...
  py::class_<BFS_f_Planner, Planner>(m, "BFS_f_Planner")
    .def(py::init<>())
  ...
  py::class_<BRFS_Planner, Planner>(m, "BRFS_Planner")
    .def(py::init<>())
  ...
  py::class_<Approximate_BFWS, Planner>(m, "Approximate_BFWS")
    .def(py::init<>())
  ...
  py::class_<DFIW_Planner, Planner>(m, "DFIW_Planner")
    .def(py::init<>())
  ...
  py::class_<DFSIW_Planner, Planner>(m, "DFSIW_Planner")
    .def(py::init<>())
  ...
  py::class_<DFS_Plus_Planner, Planner>(m, "DFS_Plus_Planner")
    .def(py::init<>())
  ...
  // py::class_<Approximate_DFS_Plus, Planner>(m, "Approximate_DFS_Plus")
  //   .def(py::init<>())
  ...
  py::class_<IW_Planner, Planner>(m, "IW_Planner")
    .def(py::init<>())
  ...
  // py::class_<Approximate_IW, Planner>(m, "Approximate_IW")
  //   .def(py::init<>())
  ...
  py::class_<RPIW_Planner, Planner>(m, "RPIW_Planner")
    .def(py::init<>())
  ...
  // py::class_<Approximate_RP_IW, Planner>(m, "Approximate_RP_IW")
  //   .def(py::init<>())
  ...
  py::class_<SIW_Planner, Planner>(m, "SIW_Planner")
    .def(py::init<>())
  ...
  // py::class_<Approximate_SIW, Planner>(m, "Approximate_SIW")
  //   .def(py::init<>())
  ...
  py::class_<SIW_Plus_Planner, Planner>(m, "SIW_Plus_Planner")
    .def(py::init<>())
  ...
  py::class_<SIW_PLUS_BFS_F_Planner, Planner>(m, "SIW_PLUS_BFS_F_Planner")
    .def(py::init<>())
