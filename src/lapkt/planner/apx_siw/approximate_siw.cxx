...
#include <lapkt/utils/memory.hxx>
...
Approximate_SIW::Approximate_SIW()
		: Planner(), m_iw_bound(2), m_log_filename("iw.log"), m_plan_filename("plan.ipc"), m_sampling_factor(1.0), m_sampling_strategy("rand")
{
}
