...
#include <lapkt/engine/node_eval/heuristic/h_unsat.hxx>

#include <lapkt/engine/open_list.hxx>
#include <lapkt/engine/at_gbfs_3h.hxx>
// #include <lapkt/engine/at_rwbfs_dq_mh.hxx>
...
class AT_LAPKT_Planner : public Planner
{
public:
    ...
    AT_LAPKT_Planner();
    AT_LAPKT_Planner(const AT_LAPKT_Planner &) = delete;
    virtual ~AT_LAPKT_Planner();

    void setup();
    void solve(aptk::STRIPS_Problem* problem);
